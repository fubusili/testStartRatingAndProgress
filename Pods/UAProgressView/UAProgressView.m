...
@property (nonatomic, strong) CAShapeLayer *shapeBackLayer;
...
@synthesize backCircleColor = _backCircleColor;
...
- (void)setBorderWidth:(CGFloat)borderWidth {
	...
	self.progressView.shapeBackLayer.lineWidth = borderWidth;
}
...
- (UIColor *)backCircleColor {
    ...
    if (_backCircleColor == nil) {
        _backCircleColor = [UIColor colorWithRed:0.43 green:0.43 blue:0.43 alpha:1.0];
    }
    return _backCircleColor;
}

- (void)setBackCircleColor:(UIColor *)backCircleColor {
    
    if (backCircleColor == nil) {
        backCircleColor = self.backCircleColor;
    } else {
    
        _backCircleColor = backCircleColor;
    }
    
    self.progressView.shapeBackLayer.strokeColor = backCircleColor.CGColor;
    self.progressView.shapeBackLayer.borderColor = backCircleColor.CGColor;
...
- (CAShapeLayer *)shapeLayer {
    if (!_shapeLayer) {
        ...
        _shapeBackLayer.fillColor = [UIColor whiteColor].CGColor;
    }
    return _shapeLayer;
}
- (CAShapeLayer *)shapeBackLayer {
    if (!_shapeBackLayer) {
        _shapeBackLayer = [CAShapeLayer new];
        _shapeBackLayer.fillColor = nil;
        _shapeBackLayer.frame = self.bounds;
    }
    return _shapeBackLayer;
}
...
- (void)setUpSubViews {
    ...
    [self.layer addSublayer:self.shapeBackLayer];
...
- (void)layoutSubviews {
    ...
    self.shapeBackLayer.cornerRadius = self.frame.size.width / 2.0f;
    self.shapeBackLayer.path = [self layoutPath].CGPath;
...
- (UIBezierPath *)layoutPath {
	...
	CGFloat borderWidth = self.shapeLayer.borderWidth/2;
